      ...
      <main id="main-content" class="site-main blogs-main">
        <section class="hero section blogs-hero" aria-labelledby="blogs-hero-title">
          ...
          <div class="container container--wide blogs-hero__inner">
            ...
            <aside class="blogs-hero__network card" aria-label="HackUnion stories network visual" data-animate="fade-left">
              <p class="blogs-hero__network-kicker">SYSTEM / OPEN KNOWLEDGE</p>
              <p class="blogs-hero__network-metric blogs-hero__network-metric--stories">STORIES / 12+</p>
              <p class="blogs-hero__network-metric blogs-hero__network-metric--categories">CATEGORIES / 06</p>

              <svg class="blogs-hero__network-svg" viewBox="0 0 420 300" aria-hidden="true" focusable="false">
                <g class="blogs-hero__network-lines">
                  <path d="M96 154 L146 96 L250 84 L320 148 L268 224 L154 212 Z"></path>
                  <path d="M146 96 L210 156 L268 224"></path>
                  <path d="M96 154 L210 156 L320 148"></path>
                  <path d="M154 212 L210 156 L250 84"></path>
                </g>
                <g class="blogs-hero__network-rings">
                  <circle cx="146" cy="96" r="9"></circle>
                  <circle cx="250" cy="84" r="8"></circle>
                  <circle cx="320" cy="148" r="9"></circle>
                  <circle cx="268" cy="224" r="9"></circle>
                  <circle cx="154" cy="212" r="9"></circle>
                </g>
                <g class="blogs-hero__network-nodes">
                  <circle class="blogs-hero__network-node blogs-hero__network-node--build" cx="146" cy="96" r="4"></circle>
                  <circle class="blogs-hero__network-node blogs-hero__network-node--learn" cx="250" cy="84" r="4"></circle>
                  <circle class="blogs-hero__network-node blogs-hero__network-node--share" cx="320" cy="148" r="4"></circle>
                  <circle class="blogs-hero__network-node blogs-hero__network-node--collaborate" cx="268" cy="224" r="4"></circle>
                  <circle class="blogs-hero__network-node blogs-hero__network-node--ship" cx="154" cy="212" r="4"></circle>
                </g>
              </svg>

              <div class="blogs-hero__network-core">
                <p class="blogs-hero__network-title">HACKUNION / STORIES</p>
                <p class="blogs-hero__network-flow">IDEA -&gt; BUILD -&gt; LEARN -&gt; SHARE</p>
              </div>

              <ul class="blogs-hero__network-tags" aria-hidden="true">
                <li class="blogs-hero__network-tag blogs-hero__network-tag--builders">BUILDER STORIES</li>
                <li class="blogs-hero__network-tag blogs-hero__network-tag--community">COMMUNITY</li>
                <li class="blogs-hero__network-tag blogs-hero__network-tag--build">BUILD &amp; SHIP</li>
                <li class="blogs-hero__network-tag blogs-hero__network-tag--source">OPEN SOURCE</li>
                <li class="blogs-hero__network-tag blogs-hero__network-tag--events">EVENTS &amp; EXPERIENCES</li>
              </ul>

              <span class="blogs-hero__network-signal" aria-hidden="true"></span>
            </aside>
          </div>
        </section>
