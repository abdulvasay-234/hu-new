      ...
      <main id="main-content" class="site-main blogs-main">
        <section class="hero section blogs-hero" aria-labelledby="blogs-hero-title">
          ...
          <div class="container container--wide blogs-hero__inner">
            ...
            <aside class="blogs-hero__publication card" aria-label="Latest from HackUnion" data-animate="fade-left">
              <p class="blogs-hero__publication-kicker">LATEST FROM HACKUNION</p>

              <div class="blogs-hero__system" aria-hidden="true">
                <span class="blogs-hero__index blogs-hero__index--01">01</span>
                <span class="blogs-hero__index blogs-hero__index--02">02</span>
                <span class="blogs-hero__index blogs-hero__index--03">03</span>
                <ul class="blogs-hero__channels">
                  <li>BUILD &amp; SHIP</li>
                  <li>OPEN SOURCE</li>
                  <li>COMMUNITY</li>
                  <li>EVENTS</li>
                </ul>
                <span class="blogs-hero__rule blogs-hero__rule--top"></span>
                <span class="blogs-hero__rule blogs-hero__rule--bottom"></span>
                <span class="blogs-hero__dot blogs-hero__dot--a"></span>
                <span class="blogs-hero__dot blogs-hero__dot--b"></span>
              </div>

              <a class="blogs-hero__latest" data-blog-hero-latest href="./interledger-technology-rethinking-the-future-of-global-payments/" aria-label="Read latest article: Interledger Technology: Rethinking the Future of Global Payments">
                <p class="blog-chip" data-blog-hero-category>AI &amp; Technology</p>
                <h2 class="blogs-hero__latest-title" data-blog-hero-title>Interledger Technology: Rethinking the Future of Global Payments</h2>
                <p class="blogs-hero__latest-excerpt" data-blog-hero-excerpt>Discover how Interledger enables secure and interoperable global payments, and why it matters for builders shaping the future of financial infrastructure.</p>
                <span class="blogs-hero__latest-cta">Read article -&gt;</span>
              </a>
            </aside>
          </div>
        </section>
